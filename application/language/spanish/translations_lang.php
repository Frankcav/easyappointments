...
// Spanish
$lang['page_title'] = 'Reservar una cita con';
$lang['service_and_provider'] = 'Seleccione Servicio y Profesor/a';
$lang['select_service'] = 'Seleccione Servicio';
$lang['select_provider'] = 'Seleccione Profesor/a';
...
$lang['appointment_booked'] = 'Su cita ha sido reservada exitosamente';
...
$lang['appointment_locked_message'] = 'La cita no se puede reservar con menos de {$limit} horas.';
...
$lang['manage_appointment_record_hint'] = 'Gestionar todas las citas reservadas de los profesores y servicios disponibles.';
$lang['select_filter_item_hint'] = 'Seleccionar un profesor/a o un servicio y ver las citas en el calendario.';
$lang['enable_appointment_sync_hint'] = 'Habilitar la sincronización de la cita con la cuenta de Google Calendar del profesor/a.';
$lang['manage_customers_hint'] = 'Gestionar los clientes registrados y ver su historial de citas reservadas.';
$lang['manage_services_hint'] = 'Gestionar los servicios y las categorías disponibles del sistema.';
$lang['manage_users_hint'] = 'Gestionar usuarios internos (administradores, profesores, asistentes).';
$lang['settings_hint'] = 'Establecer configuración de sistema y usuario.';
$lang['log_out_hint'] = 'Cerrar sesión del sistema.';
$lang['unavailability_periods_hint'] = 'El profesor/a no podrá aceptar nuevas citas cuando se encuentre como No disponible.';
...
$lang['providers'] = 'Profesores';
$lang['secretaries'] = 'Asistentes/as';
...
$lang['provider_saved'] = 'Profesor/a guardado exitosamente';
$lang['secretary_saved'] = 'Asistente guardado exitosamente';
$lang['admin_deleted'] = 'Administador eliminado exitosamente';
$lang['provider_deleted'] = 'Profesor/a eliminado exitosamente';
...
$lang['add_breaks_during_each_day'] = 'Agregar periodos de descanso para cada día. Durante los periodos de descanso los profesores no podrán aceptar ninguna cita.';
$lang['day'] = 'Día';
$lang['days'] = 'Días';
...
$lang['go_to_booking_page'] = 'Ir a la página para reservar';
...
$lang['edit_working_plan_hint'] = 'Marque abajo los días y horarios en que su empresa aceptará citas. Será posible reservar citas fuera del horario de trabajo, pero los clientes no podrán reservar citas ellos mismos en esos horarios.  Este será el esquema del horario laboral por defecto para todos los nuevos profesores registrados, pero podrá cambiar el esquema de cada profesor/a editando su registro. Luego se podrá agregar periodos de descanso.';
$lang['edit_breaks_hint'] = 'Agrgar los periodos de descanso de trabajo en cada día. Se aplicarán estos periodos de descanso para todos los nuevos profesores/as.';
$lang['book_advance_timeout'] = 'Bloquear tiempos muertos';
$lang['book_advance_timeout_hint'] = 'Defina el tiempo muerto (en minutos) antes que de los clientes puedan reservar o reorganizar citas con la empresa.';
$lang['timeout_minutes'] = 'Tiempo muerto (en minutos)';
$lang['about_app_info'] = 'Easy!Appointments es un aplicativo web completamente personalizable que le permitirá a sus clientes reservar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
...
$lang['book_appointment_title'] = 'Reservar cita';
...
$lang['delete_provider'] = 'Eliminar Profesor/a';
...
$lang['any_provider'] = 'Cualquier Profesor/a';
...
$lang['customer_notifications_hint'] = 'Define si su cliente recibirá notificaciones de correo cada vez que una reserva cambia o alguna de sus citas.';
...
$lang['overwrite_existing_working_plans'] = 'Esto sobreescribirá los planes de trabajo existentes del profesor/a. ¿Seguro que desea continuar?';
$lang['working_plans_got_updated'] = 'Todos los planes de trabajo fueron actualizados.';
$lang['apply_to_all_providers'] = 'Aplicar a todos los profesores';
$lang['display_any_provider'] = 'Opción de mostrar cualquier profesor/a';
$lang['display_any_provider_hint'] = 'La página de reserva tendrá una opción adicional que permitirá que los clientes se anoten sin específicar un profesor/a.';
...
$lang['disable_booking_hint'] = 'La página de reservas se deshabilitará por tanto tiempo como este ajuste esté activo, los clientes no serán capaces de reservar nuevas citas.';
...
$lang['limit_customer_access_hint'] = 'Si está activado, los profesores y los asistentes solo podrán acceder a los clientes con los que tengan alguna cita.';
$lang['url'] = 'URL';
...
$lang['provider_save'] = 'Guardar profesor/a';
$lang['provider_delete'] = 'Eliminar profesor/a';
$lang['secretary_save'] = 'Guardar asistente';
$lang['secretary_delete'] = 'Eliminar asistente';
...
$lang['allow_rescheduling_cancellation_before'] = 'Permitir cambiar reserva/cancelar antes';
...
$lang['year'] = 'Año';
$lang['make_non_working_day'] = 'Este profesor/a no está disponible en el día seleccionado.';
...
$lang['blocked_periods_hint'] = 'Define períodos de tiempo donde las reservas estarán deshabilitadas para todos los profesores (p. ej. fechas de cierre, vacaciones, etc.).';
